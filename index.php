<?php
	...
	$obra = new Obra();
	$obrasDisponibles = $obra->getObrasDisponibles();

	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
		$nombre = $_POST['nombre'];
		$aforo = $_POST['aforo'];
		$disponibilidad = $_POST['aforo'];
		$sala = $_POST['sala'];
		$fecha_obra = $_POST['fecha_obra'];

		$obra = new Obra();

		if ($obra_id = $obra->crearObra($nombre, $aforo, $disponibilidad, $sala, $fecha_obra)) {
            ...
            <div class="col-12 col-md-3 mb-3">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-footer text-center">
                        <a class="btn btn-success" href="compra.php?cod_obra=<?php echo $obra['cod_obra']; ?>">Comprar</a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
